...
?>
        ...
        $item_total += ($item["sale_price"]*$item["quantity"]);
				...
				<td>
					<input type="text" disabled=""  id="quantity<?php echo $item["barcode"]; ?>" style="width: 50px;" name="quantity" value="<?php echo $item["quantity"]; ?>">
				</td>
				<td align=left><?php echo "".$item["sale_price"]; ?></td>

				<td><a class="btnRemoveAction cart-action"><i class="fa fa-trash" style="color:red;"></i>
</a></td>
				</tr>
				<?php
		}
