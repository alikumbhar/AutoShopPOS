 ...
 if($c['firstname']): ?>
    <option value="<?= $c['id']; ?> "><?= $c['firstname']." ".$c['lastname']; ?></option>
      ...
      <button data-toggle="modal"  data-target="#exampleModal" class="btn btn-sm btn-info " style="margin-bottom: 10px; cursor: pointer;" aria-hidden="true">Add Customer</button>
        <input type="text" id="search-box" placeholder="Enter Barcode Scanner" class="form-control"  style="width: 250px;">
...
<ul>
    ...
    <li>Sec<span id="seconds"></span></li>
      ...
      <a href="../admin/items/add_item"><button class="btn btn-success" style="float:right;margin-top: 10px;margin-bottom: 10px;">Add Products</button></a>
...
<button style="margin-top:10px;" type="button" onclick="getCategoryItem('<?= $value['category_id']; ?>')" class="<?php echo $color[$rand_keys[$r]];?>"><?= $value['category']; ?></button>
<?php
    }
  }
    ...
    <div class="modal-content" style="height: 500px;">
      ...
      <div class="modal-body">
        ...
        <div class="form-three widget-shadow">
                ...
                <div class="form-group">
                  <div class="col-sm-8">
               <button class="btn btn-info" id="sb" style="margin-right:100px;margin-top:10px"> <a href='getPrint.php' data-toggle="modal" data-target="#myModal" data-remote="false" >
            Submit</a></button>
                  </div>
