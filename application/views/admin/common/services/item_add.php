          ...
          <form  action="">  
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input onkeypress="return isNumber(event)" id="sku" name="barcode" type="text" data-toggle="tooltip" title="please enter only numbers" class="form-control" required="" placeholder="Barcode">
                                                </div>
                            ...
                            <?php endforeach; ?>
                                         ...
                                         <a class="Primary mg-b-10"  data-toggle="modal" data-target="#getBrand" data-backdrop="false">New Brand</a>
                                                ...
                                                <div class="form-group">
                                                   <span class="aestric
                                                    ">*</span>
                                                    <input onkeypress="return isNumber(event)" data-toggle="tooltip" title="please enter only numbers" id="sale_price" name="sale_price" type="text" class="form-control" placeholder="sale price">
                                                </div>           
                                                <div class="form-group">
                                                    <span class="aestric
                                                    ">*</span>
                                                    <input onkeypress="return isNumber(event)" id="cost" name="Cost"  type="text" data-toggle="tooltip" title="please enter only numbers " class="form-control" placeholder="Cost">
                                                </div>                       
                                                <hr>  
                                                <div class="form-group">
                                                    <span class="aestric
                                                    ">*</span>
                                                    <input onkeypress="return isNumber(event)" id="stock_level" name="stock_level" type="text" data-toggle="tooltip" title="please enter only numbers " class="form-control" placeholder="Stock Level">
                                                </div>   
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input onkeypress="return isNumber(event)" id="stock_limits" name="stock_limits" type="text" data-toggle="tooltip" title="please enter only numbers " class="form-control" placeholder="Stock alert">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top: -15px">
                                                ...
                                                <div class="form-group">
                                                    <input onkeypress="return isNumber(event)" id="promo_code" name="promo_code" type="text" data-toggle="tooltip" title="please enter only numbers " class="form-control ins" placeholder="Promo Code">
                                                </div>
...
<hr>
                ...
                <button id="sb-product" class="btn btn-primary waves-effect waves-light">Add Product</button>
                                                </div>
