			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						...
						<h2 class="title1">Edit Bank Deposit</h2>
				</div>
				...
				<div class="form-three widget-shadow">
							...
							<form action="<?= base_url().$path.'/banking/updateDeposit/'.$bank->id;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
<?php if($msg){	?>
...
?>
						<div class="form-group">
							...
							<select name="account_name" class="form-control">
								...
								<?php if ( $accN->payee_name == $bank->account_name ){?> 
								<option selected="" value="<?= $bank->account_name; ?>"><?= $bank->account_name ?></option>
								<?php }else{  ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select name="account_type" class="form-control">
											<?php if ( $bank->account_type  ){ ?>
											<option selected="" value="<?php echo $bank->account_type; ?>"><?php echo strtoupper($bank->account_type); ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  name="account_no" value="<?= $bank->account_no; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  name="bank_name" value="<?= $bank->bank_name; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  name="opening_balance" value="<?= $bank->opening_balance; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="<?= $bank->bank_address; ?>"  name="bank_address" class="form-control1">
									</div>
								...
								<div class="form-group mb-n" style="color:red">
									...
									<div class="col-sm-8">
										<input type="submit" class="btn btn-info form-control1 " id="add-btn" value="Update">
									</div>
								</div>	
