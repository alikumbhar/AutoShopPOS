		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<h2 class="title1">Add Service type  </h2>
					</div>

				<div class="form-three widget-shadow">
					
							<form action="<?= base_url().$path.'/services/insertServiceType';?>" method="post" class="form-horizontal">
<?php if($msg){
						?>
					<div class="alert alert-success">
  						...
  						<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>									    
							  ...
							  <?php } ?>									
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="service_type_name" class="form-control1" id="service_type_name">
									</div>
								...
								<div class="form-group mb-n" style="color:red">
									...
									<div class="col-sm-8">
										<input type="submit" class="btn btn-info form-control1 " id="cateID" value="Add Service Type">
									</div>
								</div>
							</form>
						</div>
						...
						<table class="table table-bordered" id="employee_id">
							...
							<?php  $sr =1; foreach($service_types as $ser): ?>
							<tr>
								<td><?= $sr++; ?></td>					
								<td><?= $ser->service_type; ?></td>

								<td><a href="<?= base_url().$path.'/services/edit_service_type/'.$ser->st_id; ?>"><button class="btn btn-info">Edit</button></a></td>
								<td><a onclick="if(confirm('Do you want to delete this Service Type?')){ return true; } else {return false;} " href="<?= base_url().$path."/services/delete_service_type/".$ser->st_id?>"><button class="btn btn-danger">Delete</button></a></td>																																
							</tr>
						<?php endforeach; ?>
						</table>
...
<script type="text/javascript">
	...
	var st_name = $('#service_type_name').val()
	if(st_name == ''){
