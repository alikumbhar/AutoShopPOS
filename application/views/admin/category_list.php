		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<h2 class="title1">Postal Code - City  </h2>
					</div>
						...
						<table class="table table-bordered">
							...
							<tr>
								<td><?= $sr++; ?></td>					
								<td><?= $ser->category; ?></td>
								<td><?= $ser->category_detail; ?></td>

								<td><a href="<?= base_url().$path.'/services/edit_service/'.$ser->category_id; ?>"><button class="btn btn-info">Edit</button></a></td>
								<td><a onclick="if(confirm('Do you want to delete service?')){ return true; } else {return false;} " href="<?= base_url().$path."/services/delete_service/".$ser->category_id?>"><button class="btn btn-danger">Delete</button></a></td>																																
							</tr>
						<?php endforeach; ?>
						</table>
