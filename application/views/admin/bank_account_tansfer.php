			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						...
						<h2 class="title1">Bank Account Transfer</h2>
				</div>
					<?php $msg = $this->session->flashdata('msg'); ?>
					<?php $remove = $this->session->flashdata('remove');  ?>				
				<div class="form-three widget-shadow">
					
							<form action="<?= base_url().$path.'/banking/insertTFunds';?>" method="post" class="form-horizontal" enctype="multipart/form-data">
<?php if($msg){	?>
					<div class="alert alert-success">
						...
						<?php	
  						...
  						<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>									    
							  ...
							  $getAcc =  $this->sc_model->getAccount();
 ?>									
							...
							<div class="form-group">
									...
									<option>From</option>
									<?php foreach($getAcc as $accounter): ?>
										<option value="<?= $accounter->id ?>"><?= 
										$accounter->payee_name; ?></option>
									<?php endforeach; ?>
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="ft_date" value="" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="ft_detail" value="" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="ft_amount" value="" class="form-control1">
...
<!-- 								<div class="form-group">
									...
									<div class="col-sm-8">
									<select name="ft_category" class="form-control">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="ft_reference" value="" class="form-control1">
