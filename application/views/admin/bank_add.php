			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						...
						<h2 class="title1">Add Bank</h2>
				</div>
					<?php $msg = $this->session->flashdata('msg'); ?>
					<?php $remove = $this->session->flashdata('remove');  ?>				
				<div class="form-three widget-shadow">
					<?php  $p = $path.'/settings/insertBank' ?>
			<form action="<?php echo base_url($p);?>" method="post" class="form-horizontal" enctype="multipart/form-data">
<?php if($msg){	?>
 ...
 ?>									
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="ac_no" value="" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="" required="" name="bank_location" class="form-control1">
									</div>

								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Bank Detail</label>
									<div class="col-sm-8">
										<input type="text" value="" required="" name="bank_detail" class="form-control1">
									</div>
