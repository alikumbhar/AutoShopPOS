...
if($userPermission->can_edit == 'yes'){
    ...
    redirect('admin/banking/add_cheque');
}
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="form-three widget-shadow">
							...
							<form action="<?= base_url().$path.'/banking/updateCheque';?>" method="post" class="form-horizontal" enctype="multipart/form-data">
<?php if($msg){	?>
					<div class="alert alert-success">
					  ...
					  ?>	
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="bank_name" value="<?= $cheque->bank_name; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="cheque_book" value="<?= $cheque->cheque_book; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="<?= $cheque->leaf; ?>" required="" name="leaf" class="form-control1">
									</div>
