...
<!-- 							  <a href="<?php  echo base_url().'admin/items/export';?>"><span id="ex" class="btn btn-info btn-sm" style="float: right;margin-left: 5px;">Export</span></a>
           ...
           <div class="row">
            ...
            echo $msg; 
            ?>
          <form action="<?php echo base_url().'admin/items/addProducts'; ?>" method="post" enctype="multipart/form-data" >  
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input id="sku" name="barcode" type="text" class="form-control" required="" placeholder="Barcode">
                                                </div>

                                                <div class="form-group">
                                                    <span class="aestric
                                                    ">*</span>
                                                    <input id="description" name="description"  type="text" class="form-control" placeholder="Product Name" required="">
                                                </div>  
                                                 <hr>                   
                                       <div class="form-group">
                            ...
                            <?php endforeach; ?>
                                         ...
                                         <a class="Primary mg-b-10"  data-toggle="modal" data-target="#getBrand" data-backdrop="false">New Brand</a>
                                                ...
                                                <div class="form-group">
                                                   <span class="aestric
                                                    ">*</span>
                                                    <input id="sale_price" name="sale_price" type="text" class="form-control" placeholder="sale price">
                                                </div>           
                                                <div class="form-group">
                                                    <span class="aestric
                                                    ">*</span>
                                                    <input id="cost" name="Cost" type="text" class="form-control" placeholder="Cost">
                                                </div>                       
                                                <hr>  
                                                <div class="form-group">
                                                    <span class="aestric
                                                    ">*</span>
                                                    <input id="stock_level" name="stock_level" type="text" class="form-control" placeholder="Stock Level">
                                                </div>   
                        ...
                        <?php foreach($unit as $uni):   ?>
                            ...
                            <?php endforeach; ?>
                                         ...
                                         <a class="Primary mg-b-10"  data-toggle="modal" data-target="#getUnit" data-backdrop="false">New Unit</a>                                                
                                                ...
                                                <div class="form-group">
                                                    <input id="stock_limits" name="stock_limits" type="text" class="form-control" placeholder="Stock alert">
                                                </div>
                                                <div class="form-group">
                                                    <textarea id="comments"
                                                    name="comments" class="form-control" placeholder="comments"></textarea>
                                                </div>                                                                                                               </div>
...
<!--                                                 <div class="form-group">
                                                    <input id="promo_code" name="promo_code" type="text" class="form-control ins" placeholder="Promo Code">
                                                </div> -->
                                                ...
                                                <div class="form-group">
                                                    <input id="net_weight" name="net_weight" type="text" class="form-control ins" placeholder="Net Weight">
                                                </div>
                                                <div class="form-group">
                                                    <input id="gross_weight" name="gross_weight" type="text" class="form-control ins" placeholder="Gross Weight">
                                                </div>
                                                <hr>                         
...
<hr> 
                                ...
                                <span class="input-group-addon">
									...
									<input class="form-control" type="text" id="datepicker" name="expiration_date" placeholder="expiration date">
									</div>
...
<?php if($userPermission->can_add == 'yes'){ ?>
                <input type="submit" name="submit" value="Add Product" id="sb-product" class="btn btn-primary waves-effect waves-light">
<?php    }else{ ?>
                <button onclick="failedRec()" class="btn btn-primary waves-effect waves-light">Add Product</button>
    <?php 
}
    ?>
                                                </div>
...
<!-- add unit modal started -->

    <div id="getUnit" class="modal modal-edu-general default-popup-PrimaryModal PrimaryModal-bgcolor fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-close-area modal-close-df">
                    <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                ...
                <div class="modal-body">
                    ...
                    <div class="brandAdded" style="color:black"></div>
                    <div class="form-group">
                    <input type="text" id="add_unit" name="brand" class="form-control" placeholder="Unit">
                    </div>
                    <a href="#" id="unit-btn" data-dismiss="modal" class="btn btn-primary waves-effect waves-light">Add Unit</a>
                </div>
                <div class="modal-footer footer-modal-admin">
                    <a data-dismiss="modal" href="#">Cancel</a>
...
$('[id^=stock_limits]').keypress(validateNumber);
$('[id^=stock_level]').keypress(validateNumber);
...
$('#cost').keyup(function(){
    ...
    parseInt(sale_price)
    parseInt(cost)
    if(parseInt(sale_price) < parseInt(cost) ){
        if(confirm('please check cost is greater than sale price if you want to continue please press ok else cancel it.')){ 
         }else{ 
         $('#cost').val('');
         return false;
     }
...
var catText     = $("#category_id option[value='2']").text();
var brandText   = $("#brand_id option[value='2']").text();
var supplierText= $("#supplier_id option[value='2']").text();
...
if(stock_level ==''){
        alert('please enter Stock Level')
    return false
}
if(stock_limits ==''){
...
// var vsku= "s"+sku;
// var itemurl = "<?= base_url().'admin/inventory?msg';?>"
...
var path = "<?= base_url().'admin/brand/insertUnitModal';?>"
...
success: function(data) {
$("#add_unit").val('');
    $("#getUnitID").load("<?php echo base_url().'admin/brand/getUnitBySelect';?>");
