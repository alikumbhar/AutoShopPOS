			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						...
						<h2 class="title1">Update Roles</h2>
				</div>
				
				<div class="form-three widget-shadow">
					<div class="modal-body ng-scope" id="modal-body"><div bind-html-compile="rawHtml">	

<form class="form-horizontal ng-pristine ng-valid ng-scope ng-valid-required" id="user-group-form" action="<?php echo base_url('admin/users/update_role') ?>" method="post">
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text"  id="name"  value="<?php print_r($roles[0]->name); ?>" name="role_name" required="">
        <input type="hidden"   value="<?php print_r($this->uri->segment(4)); ?>" name="role_id" required="">        
      </div>
    </div>
