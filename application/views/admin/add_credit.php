		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<h2 class="title1">Add Credit </h2>
					</div>

				<div class="form-three widget-shadow">
					
							<form action="<?= base_url().$path.'/customers/insertCredit';?>" method="post" class="form-horizontal">
<?php if($msg){
						?>
  						...
  						<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>									    
							  ...
							  <?php } ?>									
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="credit" class="form-control1" id="service_name">
									</div>
...
<!-- 								<th>Edit</th> -->
							...
							<?php  $sr =1; foreach($credit as $ser): ?>
							<tr>
								<td><?= $sr++; ?></td>					
								<td><?= $ser->credit; ?></td>
								<td><?= $ser->firstname." ".$ser->lastname ?></td>								

<!-- 								<td><a href="<?= base_url().$path.'/customers/edit_credit/'.$ser->c_id; ?>"><button class="btn btn-info">Edit</button></a></td> -->
								<td><a onclick="if(confirm('Do you want to delete this Credit?')){ return true; } else {return false;} " 
									href="<?= base_url().$path.'/customers/delete_credit/'.$ser->c_id;?>"><button class="btn btn-danger">Delete</button></a></td>																																
							</tr>
						<?php endforeach; ?>
						</table>
