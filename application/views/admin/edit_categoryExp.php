...
<div class="form-three widget-shadow">
							<form action="<?= base_url().$path.'/category/update_exp_category';?>" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Category Name</label>
									<div class="col-sm-8">
										<input type="text" name="category" class="form-control1" value="<?= $ser->category ?>" id="category">
										<input type="hidden" value="<?= $ser->exp_cate_id ?>" name="exp_cate_id">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea rows="6" cols="79" required="" name="category_detail" ><?= $ser->category_detail ?></textarea>
									</div>
