		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<?php $ser = $supplierID[0];  ?> 
					...
					<h2 class="title1">Edit Suppliers  </h2>
					</div>
<div class="form-three widget-shadow">
							<form action="<?= base_url().$path.'/suppliers/update_supplier';?>" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Supplier Name</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_name" class="form-control1" value="<?= $ser->supplier_name ?>" id="category">
										<input type="hidden" value="<?= $ser->supplier_id ?>" name="supplier_id">
									</div>

								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Supplier Email</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_email" class="form-control1" value="<?= $ser->supplier_email ?>" id="supplier_email">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Phone Name</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_phone" class="form-control1" value="<?= $ser->supplier_phone ?>" id="supplier_phone">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Fax Name</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_fax" class="form-control1" value="<?= $ser->supplier_fax ?>" id="">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Supplier Address</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_address" class="form-control1" value="<?= $ser->supplier_address ?>" id="">
									</div>
								</div>
<!-- 								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Supplier Tax</label>
									<div class="col-sm-8">
										<input type="text" name="supplier_tax" class="form-control1" value="<?= $ser->supplier_tax ?>" id="">
									</div>
								</div> -->
								...
								<?php } else{ ?>
									<div class="col-sm-8">
										<span onclick="failedRec()" class="btn btn-info form-control1 " id="largeinput" >Update Service</span>
									</div>
								<?php  } ?>
								</div>
							</form>
