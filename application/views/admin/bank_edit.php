			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						...
						<h2 class="title1">Edit Bank</h2>
				</div>
					<?php $msg = $this->session->flashdata('msg'); ?>
					<?php $remove = $this->session->flashdata('remove');  ?>				
				<div class="form-three widget-shadow">
					
							<form action="<?= base_url().$path.'/banking/updateBank/';?>" method="post" class="form-horizontal" enctype="multipart/form-data">
<?php if($msg){	?>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="text" required="" name="payee_name" value="<?= $bank->payee_name; ?> " class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required=""  name="account_no" value="<?= $bank->account_no; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="bank_name" value="<?= $bank->bank_name; ?>" class="form-control1">

									</div>

								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Bank location</label>
									<div class="col-sm-8">
										<input type="text" required="" name="location" value="<?= $bank->bank_location; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="datepicker" required="" name="account_created_date" value="<?= $bank->account_created_date; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="bank_detail" value="<?= $bank->bank_detail; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="amount" required="" name="amount" value="<?= $bank->amount; ?>" class="form-control1">
								...
								<div class="form-group">
									...
									<select name="payment_method" class="form-control">
										<?php if( $bank->payment_method =='bank'){?>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" required="" name="reference" value="<?= $bank->reference; ?>" class="form-control1">
