...
<html lang="zxx">
   <head>
      ...
      <!--//booststrap end-->
      <!-- font-awesome icons -->
      <link href="<?php ?><?php echo base_url()."assets/css/"?>font-awesome.css" rel="stylesheet">
      <!-- //font-awesome icons -->
      <!--stylesheets-->
   ...
   <body>
      ...
      <div class="portfolio" id="gallery">
         ...
         <div class="galler-imgs">
            <ul class="portfolio-categ filter">
               ...
               <li class="cat-item-1">
                  <a href="#" title="Category 1">portfolio 1</a>
               </li>
               <li class="cat-item-2">
                  <a href="#" title="Category 2">portfolio 2</a>
               </li>
               <li class="cat-item-3">
                  <a href="#" title="Category 3">portfolio 3</a>
               </li>
               <li class="cat-item-4">
            ...
            <ul class="portfolio-area">
               <li class="portfolio-item2" data-id="id-0" data-type="cat-item-1">
                  <div>
                     <span class="image-block img-hover">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g1.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g1.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
               ...
               <li class="portfolio-item2" data-id="id-1" data-type="cat-item-1">
                  <div>
                     <span class="image-block">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g2.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g2.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
               ...
               <li class="portfolio-item2" data-id="id-2" data-type="cat-item-1">
                  <div>
                     <span class="image-block">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g3.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g3.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
               ...
               <li class="portfolio-item2" data-id="id-3" data-type="cat-item-1">
                  <div>
                     <span class="image-block">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g4.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g4.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
               ...
               <li class="portfolio-item2" data-id="id-4" data-type="cat-item-2">
                  <div>
                     <span class="image-block">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g5.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g5.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
               ...
               <li class=" portfolio-item2" data-id="id-5" data-type="cat-item-2">
                  <div>
                     <span class="image-block">
                        <a class="image-zoom" href="<?php echo base_url()."assets/images/"?>g6.jpg" rel="prettyPhoto[gallery]">
                           <figure>
                              <img src="<?php echo base_url()."assets/images/"?>g6.jpg" class="img-responsive w3layouts agileits" alt="">
                              <figcaption>
                                 <h3>Clean & Dry</h3>
                              </figcaption>
                           </figure>
      ...
      <div class="contact" id="contact">
         <div class="container">
            ...
            <div class="row bottom-copy text-center">
               <div class="col-lg-4 col-md-4 agileits-contact-addrs">
                  <h4>Address :</h4>
                  <p>132 New Lenox, 868 1st<br> Avenue.
                     4th Street NYC.
                  </p>
               </div>
               <div class="col-lg-4 col-md-4 agileits-contact-addrs">
            ...
            <div class="agileits-contact-addrss">
               <div class="row top-gap">
                  <div class="col-md-7 header-side">
                     <p> 
                        © 2018 Clean & Dry. All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">W3Layouts</a>
                     </p>
                  </div>
